...
<?php
    ...
    $fotoUsuario = $matriculaUsuario = $nomeUsuario = $cursoUsuario = $emailUsuario = $senhaUsuario = $confirmarSenhaUsuario = "";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!$erroPreenchimento && !$erroUpload){
            ...
            $inserirUsuario = "INSERT INTO Usuarios (fotoUsuario, matriculaUsuario, nomeUsuario, cursoUsuario, emailUsuario, senhaUsuario) VALUES ('$fotoUsuario', '$matriculaUsuario', '$nomeUsuario', '$cursoUsuario', '$emailUsuario', '$senhaUsuario')";
                        ...
                        <div class='table-responsive'>
                            <table class='table'>
                                ...
                                <tr>
                                    ...
                                    <td>";
                                        switch($cursoUsuario){
                                            case "TECINF": echo "Técnico em Informática para Internet";
                                            break;
                                            case "TECJOG": echo "Técnico em Programação de Jogos Digitais";
                                            break;
                                            case "TECMEC": echo "Técnico em Mecânica";
                                            break;
                                            case "TECAUT": echo "Técnico em Automação Industrial";
                                            break;
                                        }
                                echo "</td>
                                </tr>
